            ...
            <div className="bg-white rounded-[30px] w-full max-w-md p-8 relative shadow-2xl animate-in zoom-in-95 duration-200">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="relative group">
                        <ShieldCheck className="absolute left-5 top-1/2 -translate-y-1/2 w-4 h-4 text-neutral-500 group-focus-within:text-black transition-colors" />
                        <input
                            type="text"
                            required
                            placeholder="SEU CPF"
                            className="w-full pl-14 pr-6 py-4 bg-[#F2F2F2] border border-transparent rounded-2xl text-[11px] font-bold focus:bg-white focus:border-neutral-300 focus:outline-none transition-all placeholder:text-neutral-400"
                            value={cpf}
