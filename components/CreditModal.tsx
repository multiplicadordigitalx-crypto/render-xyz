                                ...
                                >
                                    ...
                                    <div className={`w-20 h-20 rounded-full flex items-center justify-center mb-4 mt-2 ${style.highlight
                                        ...
                                        <div className="text-center">
                                            <span className="text-2xl font-black block leading-none">{pkg.amount}</span>
                                            <span className="text-[7px] font-bold uppercase opacity-80">créditos</span>
                                        </div>
                                    </div>
                                    ...
                                    <button
                                        ...
                                        disabled={!!loadingId}
                                        className={`w-full py-3.5 rounded-xl font-black text-[10px] uppercase tracking-widest flex items-center justify-center transition-all disabled:opacity-70 ${style.highlight
                                                ? 'bg-gradient-to-r from-emerald-500 to-teal-600 text-white hover:shadow-lg hover:shadow-emerald-500/30'
                                                : 'bg-black text-white hover:bg-zinc-800'
                                            }`}
                                    >
                                        {loadingId === pkg.id ? <Loader2 className="w-4 h-4 animate-spin" /> : "Comprar Agora"}
                                    </button>
                                </div>
                            );
                        })}
