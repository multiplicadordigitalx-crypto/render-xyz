            ...
            <div className="relative bg-[#F2F2F2] w-full max-w-xl rounded-[35px] overflow-hidden shadow-2xl">
                <div className="p-8 md:p-12">
                    <div className="flex justify-between items-center mb-10">
                        ...
                        <button onClick={onClose} className="p-2 bg-neutral-100 hover:bg-neutral-200 transition-colors rounded-full"><X className="w-6 h-6" /></button>
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center space-x-6 p-6 bg-white rounded-[25px] border border-[#B6B09F]/20">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black text-neutral-500 uppercase tracking-widest">{user.plan || 'Plano Free'}</p>
                            </div>
                        </div>

                        <div className="grid grid-cols-1 gap-4">
                            <div className="p-5 bg-white rounded-2xl flex items-center space-x-4 border border-neutral-200">
                                <Mail className="w-4 h-4 text-neutral-500" />
                                <div className="flex-1">
                                    <p className="text-[8px] font-black uppercase text-neutral-500">E-mail</p>
                            ...
                            <div className="p-5 bg-white rounded-2xl flex items-center space-x-4 border border-neutral-200">
                                ...
                                <div className="flex-1">
                                    <p className="text-[8px] font-black uppercase text-neutral-500">CPF</p>
                            ...
                            <div className="p-5 bg-white rounded-2xl flex items-center space-x-4 border border-neutral-200">
                                ...
                                <div className="flex-1">
                                    <p className="text-[8px] font-black uppercase text-neutral-500">Membro desde</p>
                                    <p className="text-[10px] font-bold">{new Date(user.joinedAt).toLocaleDateString('pt-BR')}</p>
                                </div>
                            </div>
                        </div>

                        <div className="pt-6 border-t border-neutral-200 flex flex-col space-y-4">
                            <button
                                onClick={onLogout}
