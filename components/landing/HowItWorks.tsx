            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center">
                ...
                <div className="order-1 lg:order-2 reveal reveal-right">
                    <h2 className="text-4xl md:text-7xl font-black mb-10 md:mb-12 uppercase tracking-tighter leading-tight">
                        O Motor de IA <br className="hidden md:block" /> por trás da Mágica
                    </h2>
                    <div className="space-y-8 md:space-y-12">
                        {[
                            { n: "1", t: "Upload Simples", d: "Arraste seu arquivo SKP ou OBJ. Esqueça a configuração manual de luzes, texturas e câmeras complexas." },
                            { n: "2", t: "Processamento Neural", d: "Nossa IA Generativa analisa a geometria e aplica materiais PBR realistas e iluminação global automaticamente." },
                            { n: "3", t: "Resultado Instantâneo", d: "Receba imagens 8K em segundos, não horas. Sem travamentos, sem placa de vídeo dedicada, tudo na nuvem." }
                        ].map((step, idx) => (
