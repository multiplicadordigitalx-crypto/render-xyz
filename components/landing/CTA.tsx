...
export const CTA: React.FC<CTAProps> = ({ onStartNow }) => {
    return (
        <section className="py-32 md:py-48 px-4 text-center bg-white border-t border-neutral-200 relative overflow-hidden">
            <div className="max-w-5xl mx-auto relative z-10">
                ...
                <div className="flex flex-col items-center space-y-8">
                    ...
                    <p className="text-neutral-500 text-[9px] md:text-[10px] font-black uppercase tracking-[0.4em] flex items-center">
